  ...
  const adjustQuestionDepth = async (originalQuestion: string, depth: number) => {
    try {
      const depthInstructions = {
        0: "Create witty, sarcastic conversation starters (60 words max). Mix question types: scenario-based with multiple choice (A, B, C, D - each option on new line, left-aligned), general multiple choice, open-ended, and true/false. Keep tone playful and slightly edgy. Examples: 'Your date says pineapple belongs on pizza. True or false: This is a dealbreaker?' or 'Best first date activity?\nA. Coffee - safe and basic\nB. Escape room - test compatibility under pressure\nC. Grocery shopping - see their snack choices\nD. Skydiving - go big or go home'",
