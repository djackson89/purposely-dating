  ...
  const adjustQuestionDepth = async (originalQuestion: string, depth: number) => {
    try {
      const depthInstructions = {
        0: "Transform this into a witty, sarcastic conversation starter with multiple choice answers (A, B, C, D). Create a realistic dating/relationship scenario that's both humorous and revealing of character. Use the tone and format of these examples: 'Your date mentions their ex will always be family because of the kids. Your response? A. Respect the co-parenting reality - maturity is attractive B. Ask for specific boundaries around family events C. Note to self: holidays might be complicated D. Wonder if you're dating them or their entire family tree'. Make it clever, relatable, and slightly edgy while exploring real relationship dynamics. Include both practical and amusing response options.",
