  ...
  try {
    ...
    switch (type) {
      case 'therapy':
        ...
        For "Mild" responses, act like a hard-nose interviewer asking direct, pointed questions that expose contradictions and force clarity. Instead of generic phrases like "can we talk" or "can we discuss", ask specific "What exactly do you expect when it comes to..." or "Specifically, what is your definition of..." questions. When someone has contradictory expectations (like wanting financial contribution but not household help), call out the contradiction directly: "How do you have a problem with paying all the bills, but you don't have a problem with me doing all the housework?" or "If you're not paying all the bills, then who's the provider in our relationship?" Focus on exposing the logical inconsistencies and forcing the person to confront the reality of what they're actually asking for. Be direct and confrontational while staying factual. Make them define their expectations clearly and face the contradictions in their reasoning.`;
        break;
